// src/data/materials.archive.ts
// ─────────────────────────────────────────────────────────────────────────────
// ARCHIVED CATALOG — retired from the live registry on 2026-07-10.
// These are the pre-Centum-Path study materials (old tracking generation).
// Retained for the upcoming revision cycle: entries will be re-added to
// materials.ts one by one as each HTML file is upgraded to the two-layer
// tracking template (window._send → /api/study/interaction + /api/events).
// NOT imported anywhere — keeping this file has zero runtime effect.
// The HTML files themselves remain untouched in public/study/.
// ─────────────────────────────────────────────────────────────────────────────
import type { Material } from './materials'

export const archivedMaterials: Material[] = [
  // ── Day 1 ──────────────────────────────────────────────────────────────────
  ...
  { id: 'day-12-geo2', day: 12, title: 'Geography — Part 2 (Revision)', htmlPath: '/study/geo-part2.html', totalNodes: 8 },
  { id: 'day-12-geo3', day: 12, title: 'Geography — Part 3 (Revision)', htmlPath: '/study/geo-part3.html', totalNodes: 13 },
  { id: 'day-13-maths-avg', day: 13, title: 'Maths — Average & Ages', htmlPath: '/study/maths-avg-ages.html', totalNodes: 9 },
  { id: 'day-14-maths-pl',  day: 14, title: 'Maths — Profit, Loss & Discount', htmlPath: '/study/maths-profit-loss.html', totalNodes: 9 },
  { id: 'day-15-eng-articles', day: 15, title: 'English — Articles (A/AN/THE)', htmlPath: '/study/eng-01-articles.html', totalNodes: 8 },
  { id: 'day-15-eng-sva',      day: 15, title: 'English — Subject-Verb Agreement', htmlPath: '/study/eng-02-sva.html', totalNodes: 8 },
  { id: 'day-15-eng-tenses',   day: 15, title: 'English — Tenses', htmlPath: '/study/eng-03-tenses.html', totalNodes: 8 },
  { id: 'day-15-ca-polity',    day: 15, title: 'Current Affairs — Indian Polity & Governance', htmlPath: '/study/ca-01-polity.html', totalNodes: 5 },
  { id: 'day-15-ca-economy',   day: 15, title: 'Current Affairs — Indian Economy', htmlPath: '/study/ca-02-economy.html', totalNodes: 5 },

  // ── Days 16–30: placeholders ──────────────────────────────────────────────
